...
lf              .equ    $0a            	; Line feed
space           .equ    $20            	; Space
uart_tx			.equ	1				; Uart Tx port
uart_rx			.equ	1				; Uart Rx port
;
...
;				
flush_rx		in      a, (uart_rx)	; Read a char from uart
				cp		$ff				; Is <> $FF?
...
; Message definitions
;
hello_msg       .byte   "iLoad - Intel-Hex Loader - S260117", eos
...
;
getc            in      a, (uart_rx)	; read a char from uart
				cp		$ff				; is = $FF?
