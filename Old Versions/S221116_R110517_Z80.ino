...
S221116 R110517 - HW ref: A041116
...
// ------------------------------------------------------------------------------
  ...
  Serial.println("IOS - I/O Subsystem - S221116 R110517");
  Serial.println();
...
// NOTE: If the Virtual Disk Module is not present the RTC wil be always disabled/not foud
{
  byte    OscStopFlag;
