...
S221116 R130417 - HW ref: A041116
...
// ------------------------------------------------------------------------------
  ...
  Serial.println("IOS - I/O Subsystem - S221116 R130417");
  Serial.println();
  if (moduleGPIO) Serial.println("IOS: Found GPIO Expansion Module");
  if (vDisk)
  // Found Virtual Disk Module
  {
  ...
  // or an invalid bootMode code was read from internal EEPROM
  {
    ...
    if (vDisk == 1)
    // Virtual disk module found, so enable CP/M and disk light selections
    {
