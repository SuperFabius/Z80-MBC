...
S221116 R200117 - HW ref: A041116
...
// ------------------------------------------------------------------------------
  ...
  Serial.println("IOS - I/O Subsystem - S221116 R200117");
  Serial.println();
      ...
      // IO READ operation requested
      {
        ...
        // Execute the requested I/O READ operation
        {
          ...
          case  0x02:
            ...
            // NOTE 2: a value 0x00 is forced for successive readings if the end of bootPhase2[] is reached.
